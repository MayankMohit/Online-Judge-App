...
const SubmissionViewPage = () => {
  ...
  if (loading) return <div className="text-center text-white mt-10"><LoadingScreen /></div>;
      ...
      <div className="flex flex-col md:flex-row gap-6 h-[70vh]">
        ...
        <div className="w-full md:w-3/5 bg-gray-800 p-4 rounded-lg overflow-hidden">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="px-2 py-1 font-semibold">{readableLanguage}</span>
          </div>
          <Editor
            height="90%"
            defaultLanguage={language === "py" ? "python" : language === "js" ? "javascript" : language}
            value={code}
            theme="vs-dark"
            options={{
              readOnly: true,
